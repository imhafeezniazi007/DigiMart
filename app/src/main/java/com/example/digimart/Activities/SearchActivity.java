...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>"+query+"</font>"));
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        getProducts(query);

        GridLayoutManager layoutManager = new GridLayoutManager(this, 2);
        activitySearchBinding.productList.setLayoutManager(layoutManager);
        activitySearchBinding.productList.setAdapter(productAdapter);
    }
    ...
    void getProducts(String query) {
        ...
        String url = Consts.GET_PRODUCTS_URL + "?q=" + query;
